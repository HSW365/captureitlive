...
export default function Landing() {
  return (
    <div>
      <section className="mesh-glow max-w-6xl mx-auto px-6 pt-16 md:pt-24 pb-20 grid md:grid-cols-2 gap-12 items-center">
        <div className="animate-rise">
          ...
          <div className="mt-8 flex flex-wrap gap-4">
            <Link href="/pricing"><Button size="lg">Join CaptureItLive — $8/mo</Button></Link>
          ...
          <div>
            ...
            <div className="grid sm:grid-cols-2 gap-x-10 gap-y-14">
              {features.map(({ icon: Icon, title, body }) => (
                <div key={title} className="rounded-2xl p-5 -m-5 card-interactive hover:bg-card/60">
