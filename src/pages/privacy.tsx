  ...
  return (
    <div className="max-w-2xl mx-auto px-6 py-20 prose">
      ...
      <div className="space-y-4 text-sm text-muted-foreground leading-relaxed">
        <p>CaptureItLive collects the information you provide directly — your name, email, role, and anything you choose to share in your profile, posts, or class listings.</p>
